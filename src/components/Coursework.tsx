...
const data: I_Coursework[] = [
  {
    ...
    description:
      "An in-depth full-stack program covering the complete development lifecycle—from building responsive front-end applications to managing back-end services and databases. Mastered core technologies like MongoDB, Express.js, React.js, Node.js, and Next.js, while focusing on creating full-stack applications, RESTful APIs, state management with Redux, and dynamic database integration.",
  },
];
